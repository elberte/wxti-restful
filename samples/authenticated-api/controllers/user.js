 ...
 * GET      - http://{server}/api/user/with-simple-posts                    - rota montada pelo metodo populate parcial
 * GET      - http://{server}/api/user/:id/with-simple-posts                - rota montada pelo metodo populate parcial
